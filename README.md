...
When started, the application transmit a packet ("Hello world") in ASCII. To check the transmission of a packet, a code in matlab using a PlutoSDR board was added with an example of plots.
